# Flags for training the VAE anomaly detector on SBND images.
# Usage: source model_flags_VAE_SBND.sh && python scripts/autoencoder_train.py $AE_TRAIN_FLAGS
#
...
export DATADIR="--data_dir /scratch/7DayLifetime/gputnam/training-SBND-VAE/iterA/filelists/train.txt --validation_dir /scratch/7DayLifetime/gputnam/training-SBND-VAE/iterA/filelists/validation.txt --charge_scale 1"
