...
|-------------------|---------|
| `01_WvfmToH5.ipynb` | Entry for waveform → h5 |
| `grid_wvfm2h5/` | Production C++ / project.py path |
...
| `MakeDetectorFeatures.ipynb` | Exploratory defect prototypes |
| `inspect_samples.ipynb` | Training sample QA |
