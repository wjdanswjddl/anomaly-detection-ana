...
DEFAULT_ROC_SAVE_DIR = Path("/exp/sbnd/data/users/munjung/anomaly-detection/roc_curves")
DEFAULT_FIG_SAVE_DIR = Path("/exp/sbnd/data/users/munjung/anomaly-detection/figures")
STYLEFILE            = str(Path(__file__).resolve().parent / "presentation.mplstyle")
